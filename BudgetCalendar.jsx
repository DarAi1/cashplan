...
export default function BudgetCalendar() {
  ...
  return (
    <div className="p-2 sm:p-4 text-gray-900 dark:text-gray-50 bg-white dark:bg-black min-h-screen transition-colors">
      <div className="relative flex justify-between items-center mb-4 backdrop-blur-md bg-white/30 dark:bg-black/20 border border-white/10 dark:border-white/5 shadow-md rounded-xl px-4 py-2">
        <button onClick={handlePrevMonth} className="text-lg px-3 py-1 rounded bg-gray-200/70 dark:bg-gray-700/60 hover:bg-gray-300 dark:hover:bg-gray-600">←</button>
        <div className="text-center flex-1">
          ...
          <button onClick={handleResetToday} className="mt-1 px-3 py-1 rounded bg-gray-200/70 dark:bg-gray-700/60 hover:bg-gray-300 dark:hover:bg-gray-600 text-sm">
            Today
          </button>
        </div>
        <button onClick={handleNextMonth} className="text-lg px-3 py-1 rounded bg-gray-200/70 dark:bg-gray-700/60 hover:bg-gray-300 dark:hover:bg-gray-600">→</button>
      </div>
